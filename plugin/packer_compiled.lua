...
_G.packer_plugins = {
  ...
  ["none-ls-extras.nvim"] = {
    loaded = true,
    path = "/home/cv-rishi/.local/share/nvim/site/pack/packer/start/none-ls-extras.nvim",
  ...
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/cv-rishi/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua",
