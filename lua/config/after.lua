...
vim.lsp.enable({ "lua_ls", "clangd", "ruff", "pyright", "prettypst", "tinymist", "rust_analyzer", "biome", "tsserver",
	"tectonic", "omnisharp", "jdtls", "postgrestools", "pgformatter", "sqlls", "htmx", "cssls", "c3_lsp", "texlab" })
